...
L<case converstions|https://en.wikipedia.org/wiki/Naming_convention_(programming)>: snake_case, VARCAPS_CASE, lisp-case, Train-Case, camelCase, PascalCase, L<lower case, UPPER CASE|https://en.wikipedia.org/wiki/Letter_case>
